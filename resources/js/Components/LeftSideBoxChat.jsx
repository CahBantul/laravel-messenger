    ...
    <>
      ...
      <div className="col-start-1 col-end-9 p-1">
        <div className="relative flex flex-row group">
          <div className={clsx(message.deleted_at ? '' : 'lg:pr-12', "py-2 pl-3 pr-3 text-xs text-gray-300 bg-gray-800 rounded-md lg:text-sm")}>
            ...
            {!message.deleted_at ?
              ...
              : (<div className="flex items-center justify-center mr-1 text-xs italic text-center select-none text-gray-400/60">{message.content}</div>)
            }
